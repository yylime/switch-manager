...
export class ArptablesService {
    ...
    /**
     * Flush Arp Background
     * Flush iptables.
     * @returns unknown Successful Response
     * @throws ApiError
     */
    public static flushArpBackground(): CancelablePromise<ArptablesFlushArpBackgroundResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/arptables/flush_arp'
        });
    }
}
...
export class DashboardService {
     ...
     * @throws ApiError
     */
    public static getCardData(): CancelablePromise<DashboardGetCardDataResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static getBranchStatistics(): CancelablePromise<DashboardGetBranchStatisticsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/dashboard/branch'
        });
    }
    
    /**
     * Get Success Count By Day
     * @param data The data for the request.
     * @param data.pastDay
     * @returns unknown Successful Response
     * @throws ApiError
     */
    public static getSuccessCountByDay(data: DashboardGetSuccessCountByDayData = {}): CancelablePromise<DashboardGetSuccessCountByDayResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/dashboard/success_count_by_day',
            query: {
                past_day: data.pastDay
            },
            errors: {
                422: 'Validation Error'
            }
...
export class DiffsService {
     ...
     * @throws ApiError
     */
    public static getConfigDiffs(data: DiffsGetConfigDiffsData): CancelablePromise<DiffsGetConfigDiffsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/diffs/diff',
            query: {
     ...
     * Get switch list.
     * id bind name
     * @returns SwitchList Successful Response
     * @throws ApiError
     */
    public static getSwitchList(): CancelablePromise<DiffsGetSwitchListResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/diffs/get_switch_list'
        });
    }
     ...
     * @throws ApiError
     */
    public static getSwitchConfigDate(data: DiffsGetSwitchConfigDateData): CancelablePromise<DiffsGetSwitchConfigDateResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/diffs/get_switch_config_date',
            query: {
                id: data.id
            },
            errors: {
     ...
     * @param data The data for the request.
     * @param data.sourceId
     * @param data.sourceDate
     * @param data.targetId
     * @param data.targetDate
     * @returns string Successful Response
     * @throws ApiError
     */
    public static getSwitchConfigDiffs(data: DiffsGetSwitchConfigDiffsData): CancelablePromise<DiffsGetSwitchConfigDiffsResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/diffs/get_switch_config_diffs',
            query: {
...
export class ScheduleService {
     ...
     * @throws ApiError
     */
    public static createBackupJob(data: ScheduleCreateBackupJobData): CancelablePromise<ScheduleCreateBackupJobResponse> {
        return __request(OpenAPI, {
            method: 'POST',
            url: '/api/v1/schedule/',
            body: data.requestBody,
    ...
    /**
     * List Backup Jobs
     * @returns BackupScheduler Successful Response
     * @throws ApiError
     */
    public static listBackupJobs(): CancelablePromise<ScheduleListBackupJobsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/schedule/jobs'
        });
    }
     ...
     * @throws ApiError
     */
    public static updateBackupJob(data: ScheduleUpdateBackupJobData): CancelablePromise<ScheduleUpdateBackupJobResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
     ...
     * @throws ApiError
     */
    public static deleteBackupJob(data: ScheduleDeleteBackupJobData): CancelablePromise<ScheduleDeleteBackupJobResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
            url: '/api/v1/schedule/{id}',
            path: {
...
export class SwitchesService {
     ...
     * @throws ApiError
     */
    public static exportSwitches(): CancelablePromise<SwitchesExportSwitchesResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/switches/export'
        });
    }
}
...
export class TasksService {
     ...
     * @param data.searchText
     * @param data.status
     * @returns BackupTasksPublic Successful Response
     * @throws ApiError
     */
    public static readBackupTasks(data: TasksReadBackupTasksData = {}): CancelablePromise<TasksReadBackupTasksResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/api/v1/tasks/',
            query: {
