...
export type Dashboard = {
    ...
    switch_backup_error_count?: number;
    vrf_count: number;
...
export type SwitchConfigDiffShow = {
...
export type ArptablesFlushArpBackgroundResponse = ({
    [key: string]: unknown;
});
...
export type DashboardGetCardDataResponse = (Dashboard);

export type DashboardGetBranchStatisticsResponse = (Array<{
    [key: string]: (string | number);
}>);

export type DashboardGetSuccessCountByDayData = {
    pastDay?: number;
};

export type DashboardGetSuccessCountByDayResponse = (Array<unknown>);

export type DiffsGetConfigDiffsData = {
    configDate: string;
};

export type DiffsGetConfigDiffsResponse = (SwitchConfigDiffShow);

export type DiffsGetSwitchListResponse = (Array<SwitchList>);

export type DiffsGetSwitchConfigDateData = {
    id: (string);
};

export type DiffsGetSwitchConfigDateResponse = (Array<(string)>);

export type DiffsGetSwitchConfigDiffsData = {
    sourceDate: string;
    sourceId: string;
    targetDate: string;
    targetId: string;
...
export type DiffsGetSwitchConfigDiffsResponse = (string);
...
export type ScheduleCreateBackupJobResponse = (unknown);

export type ScheduleListBackupJobsResponse = (Array<BackupScheduler>);

export type ScheduleUpdateBackupJobData = {
    id: string;
    requestBody: BackupJobUpdate;
};

export type ScheduleUpdateBackupJobResponse = (unknown);

export type ScheduleDeleteBackupJobData = {
    id: string;
};

export type ScheduleDeleteBackupJobResponse = (unknown);
...
export type SwitchesCreateSwitchResponse = (Switch);

export type SwitchesReadSwitchData = {
    id: string;
};

export type SwitchesReadSwitchResponse = (SwitchLite);
...
export type SwitchesUpdateSwitchResponse = (SwitchLite);
