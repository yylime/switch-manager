...
import { ipTablesColumns as columns } from './iptables-columns'
import { useIPtables } from '../data/iptables'
import { getRouteApi } from '@tanstack/react-router'
const route = getRouteApi('/_authenticated/iptables/')
...
export function IPtables() {
  ...
  const { data: serverData, isFetching } = useIPtables({ page: pagination.pageIndex + 1, pageSize: pagination.pageSize, searchText: globalFilter ?? '' })
