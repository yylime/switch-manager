...
import { useVrfs } from '../data/vrfs'
import { getRouteApi } from '@tanstack/react-router'
import { useTableUrlState } from '@/hooks/use-table-url-state'
const route = getRouteApi('/_authenticated/vrfs/')
...
export function Vrfs() {
  ...
  const { data: serverData } = useVrfs({ page: pagination.pageIndex + 1, pageSize: pagination.pageSize, searchText: globalFilter })
