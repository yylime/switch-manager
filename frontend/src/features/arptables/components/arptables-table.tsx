...
import { arpTableColumns as columns } from './arptables-columns'
import { useArptables } from '../data/arptables'

import { getRouteApi } from '@tanstack/react-router'
const route = getRouteApi('/_authenticated/arptables/')


export function Arptables() {
  ...
  const { data: serverData } = useArptables({ page: pagination.pageIndex + 1, pageSize: pagination.pageSize, searchText: globalFilter })
