...
import { inspectorsColumns as columns } from './inspectors-columns'
import { useInspectors } from '../data/inspectors'

import { getRouteApi } from '@tanstack/react-router'
const route = getRouteApi('/_authenticated/inspectors/')
...
export function InspectorsTable() {
  ...
  const { data: serverData } = useInspectors({ page: pagination.pageIndex + 1, pageSize: pagination.pageSize, searchText: globalFilter })
