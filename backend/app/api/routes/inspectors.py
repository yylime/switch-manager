...
def read_inspector(session: SessionDep, current_user: CurrentUser, id: uuid.UUID) -> Any:
    """
    Get inspector by ID.
    """
...
def create_inspector(*, session: SessionDep, current_user: CurrentUser, inspector_in: InspectorCreate) -> Any:
    """
...
@router.delete("/{id}")
def delete_inspector(session: SessionDep, current_user: CurrentUser, id: uuid.UUID) -> Message:
    """
    Delete an inspector.
    """
    inspector = session.get(Inspector, id)
