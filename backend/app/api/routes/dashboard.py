...
def get_card_data(session: SessionDep) -> Any:
    """
    Retrieve dashboard.
    """
    today = date.today()
...
def get_branch_statistics(session: SessionDep) -> Any:
    """
...
def get_success_count_by_day(session: SessionDep, past_day: int = 7) -> Any:
