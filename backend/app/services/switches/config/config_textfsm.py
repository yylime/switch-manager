...
def read_switch_sn(net_connect: BaseConnection, switch: Switch, force=False) -> dict:
    ...
    sn_textfsm_path = {
        "huawei" : "app/services/switches/config/fsm_templates/sn/huawei_sn.textfsm", 
        "huawei_ac" : "app/services/switches/config/fsm_templates/sn/huawei_ac_sn.textfsm", 
        "cisco_ios" : "app/services/switches/config/fsm_templates/sn/cisco_sn.textfsm",
        "cisco_nxos" : "app/services/switches/config/fsm_templates/sn/cisco_nxos_sn.textfsm",
        "hp_comware": "app/services/switches/config/fsm_templates/sn/h3c_sn.textfsm",
        "brocade_fos": "app/services/switches/config/fsm_templates/sn/brocade_fos.textfsm",
    }
...
def read_switch_type(net_connect: BaseConnection, switch: Switch, force=False) -> dict:
    ...
    sn_textfsm_path = {
        "huawei" : "app/services/switches/config/fsm_templates/type/huawei_type.textfsm", 
        "huawei_ac" : "app/services/switches/config/fsm_templates/type/huawei_ac_type.textfsm", 
        "cisco_ios" : "app/services/switches/config/fsm_templates/type/cisco_type.textfsm",
        "cisco_nxos" : "app/services/switches/config/fsm_templates/type/cisco_nxos_type.textfsm",
        "hp_comware": "app/services/switches/config/fsm_templates/type/h3c_type.textfsm",
        "brocade_fos": "app/services/switches/config/fsm_templates/type/brocade_fos.textfsm",
...
def read_switch_version(net_connect: BaseConnection, switch: Switch, force=False) -> dict:
    ...
    version_textfsm_path = {
        "huawei" : "app/services/switches/config/fsm_templates/version/huawei_version.textfsm", 
        "cisco_ios" : "app/services/switches/config/fsm_templates/version/cisco_version.textfsm",
        "cisco_nxos" : "app/services/switches/config/fsm_templates/version/cisco_nxos_version.textfsm",
        "hp_comware": "app/services/switches/config/fsm_templates/version/h3c_version.textfsm",
        "brocade_fos": "app/services/switches/config/fsm_templates/version/brocade_fos.textfsm",
    }
