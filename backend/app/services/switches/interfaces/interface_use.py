...
def h3c_insert(switch: Switch, data: list, session: Session):
...
def cisco_ios_insert(switch: Switch, data: list, session: Session):
    now = datetime.datetime.now()
...
def huawei_insert(switch: Switch, data: list, session: Session):
    now = datetime.datetime.now()
    for (
        interface,
        status,
